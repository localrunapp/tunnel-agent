...
exports.HttpReporter = void 0;
var axios_1 = require("axios");
var HttpReporter = /** @class */ (function () {
    function HttpReporter(backendUrl, logger) {
    ...
    HttpReporter.prototype.send = function (metrics) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.client.post('/api/metrics/ingest', metrics)];
                    case 1:
                        response = _b.sent();
                    ...
                    case 2:
                        ...
                        if (axios_1.default.isAxiosError(error_1)) {
                            ...
                            this.logger.error({ error: error_1 }, 'Unknown error sending metrics');
                        }
                        return [2 /*return*/, false];
